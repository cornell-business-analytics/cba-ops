...
export function MemberCard({ member }: MemberCardProps) {
  return (
    <Link href={`/team/${member.id}`} className="group flex flex-col rounded-lg border border-gray-100 bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow">
