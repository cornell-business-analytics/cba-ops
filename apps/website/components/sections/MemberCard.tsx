...
export function MemberCard({ member }: MemberCardProps) {
  return (
    <Link href={`/team/${member.id}`} className="flex flex-col rounded-lg border border-gray-100 bg-white overflow-hidden shadow-sm hover:shadow-md hover:border-cba-green/30 transition-all">
